...
const Navbar = ({ hideSearchBar = false }) => {
    ...
    return (
        <div className={theme == "light" ? light : dark}>
            <Link to="/" className="text-2xl text-white font-extrabold ">Shopsy</Link>
            ...
            <div className="flex justify-between items-center w-1/8">
                ...
                >
                    <input
                        ...
                        className="toggle border-indigo-600 bg-indigo-500 checked:border-pink-500 checked:bg-pink-400 checked:text-pink-800"
                    />
                </div>
