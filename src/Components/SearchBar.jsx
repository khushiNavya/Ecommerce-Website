  ...
  return (
    <div className="w-2/8 h-3/4 z-20">
      ...
      {showSearchSuggestion && (
        <div className="bg-white rounded-xl border-2  border-gray-200 p-3 w-full shadow-lg mt-1 z-20">
          {searchSuggestion.map((pObj) => {
            return (
              <Link to={`/products/${pObj.id}`} className="bg-gray-100 mb-1 p-2 rounded-xl block">
