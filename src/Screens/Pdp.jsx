...
import PdpSkelton from "../Components/PdpSkelton";
    ...
    return (
        <>
            ...
            {!loading && !error && productData && (
                <div className={theme == "light" ? "w-screen mx-auto px-6 py-10 bg-white" : "w-screen mx-auto px-6 py-10 bg-gray-300"}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        {/* Image Section */}
                        <div>
                            <div className={theme == "light" ? "border rounded-xl p-4 bg-white shadow" : "border rounded-xl p-4 bg-gray-400 shadow"}>
                                <img
                                    src={selectedImage}
